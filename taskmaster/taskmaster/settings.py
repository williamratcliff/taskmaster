# Django settings for tripleaxis project.
...
if sys.platform=='win32':
    ...
    FILES_DIR = r'C:\Users\ylem\Documents\GitHub\webrefine\tripleaxis\webrefine'
else:
...
SECRET_KEY = '2)=5kv$(18kss2#b3bw2la6+p6zoms$gfa_^@@arc=$fw9d(xl'
